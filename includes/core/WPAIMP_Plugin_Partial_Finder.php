...
class WPAIMP_Plugin_Partial_Finder {
	/**
	 * @var null|WPAIMP_Plugin_Partial_Finder
	 */
	...
	/**
	 * @return WPAIMP_Plugin_Partial_Finder|null
	 */
	public static function get_instance() {
		if ( null === self::$instance ) {
			self::$instance = new WPAIMP_Plugin_Partial_Finder();
		}
	...
	public function get_partial_path( $partial, $folder ): string {
		...
		$file_path   = WPAIMP_LOCAL_PLUGIN_PATH . DIRECTORY_SEPARATOR . $folder_path . DIRECTORY_SEPARATOR . $partial . '.php';
